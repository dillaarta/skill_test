SELECT 
	...
	orders.customer_id,
	orders.order_number as orders_order_number,
	invoices.invoice_number as invoice_invoice_number,
	CASE WHEN payments.invoice_number is not null THEN 'paid'
	WHEN invoices.order_number is null and invoices.invoice_number is null THEN 'cancel'
	ELSE 'not paid' END as order_status,
